...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  app.get('/rest/admin/application-version', retrieveAppVersion(), security.isAdmin)
  app.get('/rest/admin/application-configuration', retrieveAppConfiguration(), security.isAdmin)
  ...
  app.get('/rest/memories', getMemories(), security.isAdmin)
